            ...
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <hr class="sidebar-divider my-0">
                    ...
                    <li class="nav-item"><a class="nav-link" href="item.jsp">
                        ...
                        <i class="fas fa-table"></i><span>二手商城管理系統</span></a><a class="nav-link" href="bid.jsp">
                        ...
                        <i class="fas fa-user"></i><span>檢測維修管理</span></a><a class="nav-link active" href="frontend.jsp">
            ...
            <div id="content">
                <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3"
                        ...
                        <div class="input-group"><h2>會員管理系統</h2> </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 font-weight-bold">會員查詢</p>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                <jsp:include page="/backend/member/select_page.jsp" flush="true"/>
                            </div>
                            <div class="row">
                            </div>
                        </div>
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4 ">
                        <h3 class="text-dark mb-0">文章管理</h3>
                    </div>
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 font-weight-bold">文章查詢</p>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                <jsp:include page="/backend/forumPost/select_page.jsp" flush="true"/>
                            </div>
                            <div class="row">
                            </div>
                        </div>
...
<!--                 <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">文章檢舉管理</h3>
                    </div>
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 font-weight-bold">文章檢舉查詢</p>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive table mt-2" id="dataTable2" role="grid" aria-describedby="dataTable2_info">
                                <jsp:include page="/backend/forumPostReport/select_page.jsp" flush="true"/>
                            </div>
                            <div class="row">
                            </div>
                        </div>
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">留言管理</h3>
                    </div>
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 font-weight-bold">留言查詢</p>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive table mt-2" id="dataTable3" role="grid" aria-describedby="dataTable3_info">
                                <jsp:include page="/backend/forumMsg/select_page.jsp" flush="true"/>
                            </div>
                            <div class="row">
                            </div>
                        </div>
...
<!--                 <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">留言檢舉管理</h3>
                    </div>
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 font-weight-bold">留言檢舉查詢</p>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive table mt-2" id="dataTable3" role="grid" aria-describedby="dataTable3_info">
                                <jsp:include page="/backend/forumMsgReport/select_page.jsp" flush="true"/>
                            </div>
                            <div class="row">
                            </div>
                        </div>
