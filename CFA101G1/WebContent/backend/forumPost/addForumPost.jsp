...
<table>
	<tr>
		<td>留言內容:</td>
		<td><textarea  name="forumPostContent" style="resize:none;width:600px;height:200px;" required="required"></textarea></td>
		<td><input type="hidden" name="memno" value="${memno}"/></td>			 
	</tr>
</table>
<br>
