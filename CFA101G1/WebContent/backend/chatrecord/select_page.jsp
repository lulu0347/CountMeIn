...
<ul>
  <li><a href='<%=request.getContextPath()%>/back_end/member/listAllMember.jsp'>List</a> all Members.  <br><br></li>
...
<ul>
  <li><a href='<%=request.getContextPath()%>/back_end/member/addMember.jsp'>Add</a> a new Member.</li>
</ul>
