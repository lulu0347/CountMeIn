...
<%
	UsedReportVO usedReportVO = (UsedReportVO) request.getAttribute("usedReportVO");
%>
<!DOCTYPE html>
<html>
<head>
...
<div class="blank"></div>
	<FORM METHOD="post"
		...
		<table class="prods">
			<tr>
				<td>檢舉人編號:</td>
				<td><%=usedReportVO.getMemNo()%></td>
			</tr>
			<tr>
				<td>產品編號:</td>
				<td><%=usedReportVO.getUsedNo()%></td>
			</tr>
			<tr>
				<td>賣家編號:</td>
				<td><%=usedReportVO.getReportedMemNo()%></td>
			</tr>
			<tr>
				<td>檢舉狀態:</td>
					<td><select name="usedReportState">
			...
			<tr>
				<td>檢舉時間:</td>
				<td><%=usedReportVO.getUsedReportTime()%></td>
			</tr>
			<tr>
				<td>檢舉原因:</td>
				<td><%=usedReportVO.getUsedReportReason()%></td>
			</tr>
			<tr>
				<td>通知賣家:</td>
				<td><textArea rows="8" cols="36" name="usedProdDescription">${usedReportVO.usedReportNotice}</textArea></td>
			</tr>
			<tr>
				<td><input type="submit" value="送出"><input
					type="hidden" name="action" value="updateReport"> <input
					type="hidden" name="memNo" value="<%=usedReportVO.getMemNo()%>">
					<input type="hidden" name="usedNo"
					value="<%=usedReportVO.getUsedNo()%>"></td>
			</tr>
		</table>
	</FORM>
	</div>
