            ...
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <hr class="sidebar-divider my-0">
                    ...
                    <li class="nav-item"><a class="nav-link" href="item.jsp">
                        ...
                        <i class="fas fa-tachometer-alt"></i><span>競標後台管理</span></a><a class="nav-link active" href="auct.jsp">
...
<nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3"
                        ...
                        <div class="input-group"><h2>拍賣後台管理</h2> </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 font-weight-bold">拍賣商品查詢</p>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                <jsp:include page="/backend/auct/auctAct/select_page.jsp" flush="true"/>
                            </div>
                            <div class="row">
                            </div>
                        </div>
