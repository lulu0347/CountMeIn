            ...
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link" href="item.jsp">
                        ...
                        <i class="fas fa-tachometer-alt"></i><span>拍賣後台管理</span></a><a class="nav-link" href="auct.jsp">
                        <i class="fas fa-tachometer-alt"></i><span>競標後台管理</span></a><a class="nav-link"  href="money.jsp">
                        ...
                        <i class="fas fa-magic"></i><span>前台網站管理系統</span></a><a class="nav-link active" href="admini.jsp">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <footer class="bg-white sticky-footer">
                <div class="container my-auto">
                    <div class="text-center my-auto copyright"><span>Copyright © 2021 CountMeIn · All Rights Reserved Powered By CountMeIn</span></div>
                </div>
            </footer>
