...
<table>
	<tr>
		<td>文章檢舉內容:</td>
		<td><textarea  name="forumMsgReportWhy" style="resize:none;width:600px;height:200px;" required="required"></textarea></td>
		<td><input type="hidden" name="memNo" value="${memVO.memNo}"/></td>			 
		<td><input type="hidden" name="forumMsgNo" value="${forumMsgVO.forumMsgNo}"/></td>			 
	</tr>
</table>
<br>
