            ...
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <hr class="sidebar-divider my-0">
                    ...
                    <li class="nav-item"><a class="nav-link" href="item.jsp">
                        ...
                        <i class="fas fa-magic"></i><span>會員管理系統</span></a><a class="nav-link active" href="admini.jsp">
            ...
            <div id="content">
                <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3"
                        ...
                        <div class="input-group"><h2>員工管理</h2> </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 font-weight-bold">員工查詢</p>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                <jsp:include page="/backend/admini/select_page.jsp" flush="true"/>
                            </div>
                            <div class="row">
                            </div>
                        </div>
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">員工權限管理</h3>
                    </div>
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 font-weight-bold">員工權限查詢</p>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                <jsp:include page="/backend/adminAuth/select_page.jsp" flush="true"/>
                            </div>
                            <div class="row">
                            </div>
                        </div>
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">權限功能</h3>
                    </div>
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 font-weight-bold">權限功能查詢</p>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                <jsp:include page="/backend/adminAuthrization/select_page.jsp" flush="true"/>
                            </div>
                            <div class="row">
                            </div>
                        </div>
