  ...
  <li>
	  ...
	  <div class="card">
	    ...
	    <div id="collapseSix" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
	      <div class="card-body">
	        <b><a href="<%=request.getContextPath()%>/backend/forumPostReport/listAllForumPostReport.jsp">列出所有檢舉文章</a></b><br>	      
	      </div>
	    </div>
	  </div>
	</div>
	  ...
	  <div class="card">
		...
		<jsp:useBean id="memberSvc" scope="page" class="com.member.model.MemberService" />
	      <div class="card-body" id="searchbyid">
	      	<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/forumpostreport/forumpostreport.do" >
		        <b>選擇會員名稱 :</b>
...
$('#ibutton').on('click', function(){
	...
	$.ajax({
		 ...
		 success:function (data){
			 console.log(data);
			 let temp = "<tr><th>文章檢舉編號</th><th>文章編號</th><th>會員編號</th><th>檢舉時間</th><th>檢舉原因</th><th>檢舉狀態</th></tr><tr><td>"+ data.forumPostReportNo + "</td><td>"+data.forumPostNo+"</td><td>"+data.memNo+ "</td><td>"+data.forumPostReportTime+ "</td><td>"+data.forumPostReportWhy+ "</td><td>"+data.forumPostReportType+ "</td></tr>"
			$('#result').html(temp);
	     },
	});
});
