...
<%
	Integer bidProdState = 1;
    BidService bidSvc = new BidService();
    List<BidVO> list = bidSvc.findByBidProdState(bidProdState);
...
<html>
<head>
<title>所有競標訂單資料 - listAllBidOrder.jsp</title>
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/resources/bootstrap/css/bootstrap.min.css"/>
<link rel="stylesheet" type="text/css" href="css/bidBackend.css"/>
<style>
table {
    width: 100%;
}
...
<table id="table-1">
	<tr><td>
		 <h3>所有競標訂單資料 - listAllBidOrder.jsp</h3>
