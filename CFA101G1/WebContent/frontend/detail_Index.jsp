				...
				<div class="col-3">
					<div class="d-flex flex-column flex-shrink-0 p-3 bg-light"
						...
						<ul class="nav nav-pills flex-column mb-auto ">
							<li><a href="<%=request.getContextPath()%>/backend/itemDetail/listAll_ItemDetail.jsp" class="nav-link link-dark"> <i
									class=""> &nbsp;</i>查詢所有訂單明細</i><br>
							</a></li>
							<li><a href="<%=request.getContextPath()%>/backend/itemDetail/updateDetail.jsp" class="nav-link link-dark"> <i
									class=""> &nbsp;</i>修改訂單明細</i><br>
							</a></li>
						</ul>
						<hr>
