				...
				<div class="col-3">
					<div class="d-flex flex-column flex-shrink-0 p-3 bg-light"
						...
						<ul class="nav nav-pills flex-column mb-auto ">
							<li><a href="<%=request.getContextPath()%>/backend/itemCollection/listAllItemCollection.jsp" class="nav-link link-dark"> <i
									class=""> &nbsp;</i>查詢所有商品收藏</i><br>
							</a></li>
							<li><a href="#" class="nav-link link-dark"> <i
									class=""> &nbsp;</i>條件搜索收藏列表</i><br>
							</a></li>
						</ul>
						<hr>
						<div class="dropdown">
