				...
				<div class="col-3">
					<div class="d-flex flex-column flex-shrink-0 p-3 bg-light"
						...
						<ul class="nav nav-pills flex-column mb-auto ">
							<li class="nav-item"><a href="<%=request.getContextPath()%>/backend/item/addItem.jsp" class="nav-link link-dark">
									<i class=""> &nbsp;</i>上架商品</i><br>
							</a></li>
							<li><a href="<%=request.getContextPath()%>/backend/item/listAllItem.jsp" class="nav-link link-dark"> <i
									class=""> &nbsp;</i>查詢所有商品</i><br>
							</a></li>
							<li><a href="#" class="nav-link link-dark"> <i
									class=""> &nbsp;</i>不同條件搜索商品</i><br>
							</a></li>
							<li><a href="<%=request.getContextPath()%>/backend/item/updateItem.jsp" class="nav-link link-dark"> <i
									class=""> &nbsp;</i>修改商品</i>
							</a></li>
							<li><a href="<%=request.getContextPath()%>/backend/item/deleteItem.jsp" class="nav-link link-dark"> <i
									class=""> &nbsp;</i>刪除商品</i>
							</a></li>
							<li><a href="<%=request.getContextPath()%>/backend/itemPic/listAll_ItemPic.jsp" class="nav-link link-dark"> <i
									class=""> &nbsp;</i>更換商品照片</i>
							</a></li>
						</ul>
						<hr>
