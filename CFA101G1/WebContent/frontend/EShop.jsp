						...
						<c:if test="${itemVO.itemNo==itemPicVO.itemNo}">
								<div class="card" style="width: 18rem;">
									...
									<div class="card-body">
										...
										<input type="hidden" name="action" value="getOneItemForView"><input type="hidden" name="action" value="getOneItemForView">
...
<%-- 										<p>目前計數為 :  <c:out value="${checkcount}"/></p> --%>
										<c:choose>
										 <c:when test="${checkcount <= 0}">
											<a id ="collection-a" href="<%=request.getContextPath()%>/itemCollection/itemCollection.do?action=addCollection&memNo=${user.memno}&itemNo=${itemVO.itemNo}">
