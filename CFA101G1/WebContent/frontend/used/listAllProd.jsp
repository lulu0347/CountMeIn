			...
			<div id="div1" class="col-3">
				<div class="d-flex flex-column flex-shrink-0 p-3 bg-light"
					...
					<ul class="nav nav-pills flex-column mb-auto ">
						<li class="nav-item"><a
							href="<%=request.getContextPath()%>/used/usedServlet.do?action=searchKind&kind=1"
							class="nav-link link-dark"> <i class="bi bi-phone fs-2 mb-3">
									&nbsp;</i>Phone</i><br>
						</a></li>
						<li><a
							href="<%=request.getContextPath()%>/used/usedServlet.do?action=searchKind&kind=2"
							class="nav-link link-dark"> <i class="bi bi-laptop fs-2 mb-3">
									&nbsp;</i>Computer</i><br>
						</a></li>
						<li><a
							href="<%=request.getContextPath()%>/used/usedServlet.do?action=searchKind&kind=4"
							class="nav-link link-dark"> <i class="bi bi-camera fs-2 mb-3">
									&nbsp;</i>Camera</i><br>
						</a></li>
						<li><a
							href="<%=request.getContextPath()%>/used/usedServlet.do?action=searchKind&kind=3"
							class="nav-link link-dark"> <i
								class="bi bi-smartwatch fs-2 mb-3"> &nbsp;</i>Watch</i>
						</a></li>
						<li><a
							href="<%=request.getContextPath()%>/used/usedServlet.do?action=searchKind&kind=5"
							class="nav-link link-dark"> <i
