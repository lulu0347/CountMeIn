...
<%
	...
	MemberVO memSeller = new MemberVO();
	memSeller = memSvc.getOneMem(usedVO.getSellerNo());
%>
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="side-bar col-sm-8 col-12">
				...
				<span>賣家:${memSeller.memname}</span>
				<form action="<%=request.getContextPath()%>/used/usedServlet.do">
					<table>
						<tr>
							<td>收件人姓名: <input type="text" name="receiverName"
								value="${user.memname}"></td>
						</tr>
						<tr>
							<td><div class="input-group input-group-md">
									<span class="input-group-text " id="inputGroup-sizing">收件人地址
						...
						<tr>
							<td>收件人電話: <input type="text" name="receiverPhone"
								value="${user.memmobile}"></td>
						</tr>
						<tr>
							<td><input type="hidden" name="memNo" value="${user.memno}">
								...
								<label class="btn btn-info"><i
									class="far fa-credit-card"></i> <input type="submit"
									style="display: none">送出 </label></td>
						</tr>
					</table>
				</form>
			</div>
